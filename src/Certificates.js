...
const certificateData = [
    {
        ...
        description: `2024 - I successfully completed the 80-hour Jonas Schmedtmann JavaScript 0 to Expert course. This comprehensive program thoroughly covered the fundamentals of JavaScript programming, from basic concepts to advanced topics. Throughout the course, I gained hands-on experience by building practical projects, which allowed me to solidify my understanding and apply my newfound knowledge in real-world scenarios.`,
        index: 0,
    ...
    },
    {
        ...
        description: '2023 / 2024 - I earned a Web Development Bootcamp certificate accredited by the British Computer Society (BCS). This prestigious certification validates my skills and expertise in web development, confirming that I have met the rigorous standards set by a globally recognized professional body.',
        index: 1,
    ...
    },
    {
        ...
        description: `2023 - I earned a Front-End Developer certificate from Platzi, a leading South American online education platform. As a beginner, this course provided me with a solid foundation in coding, enabling me to develop basic single-page applications. I honed my skills in semantic HTML, CSS, and Bootstrap, mastering the art of crafting visually appealing and pixel-perfect user interfaces.`,
        index: 3,
        image: 'front-end.png',
        key: 'front-end'
    },
